...
$instance = $DB->get_record('enrol', array('id'=>$enrolid, 'enrol'=>'payro24'), '*', MUST_EXIST);
...
$PAGE->set_url('/enrol/payro24/unenrolself.php', array('enrolid'=>$instance->id));
...
$message = get_string('unenrolselfconfirm', 'enrol_payro24', format_string($course->fullname));
